#!/usr/bin/python
# inserts SSP's production data into mysql db, from excel
# Author: Aneesh PA
...
query = """INSERT INTO T_SSP_ACT_PRO (
Production_Date,
CS,
HRM,
SS_Prod,
...
CS = sheet.cell(108, col).value
HRM = sheet.cell(109, col).value
SS_Prod = sheet.cell(110, col).value
SS_Desp  = sheet.cell(111, col).value
