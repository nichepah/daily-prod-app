...
public class DateDisplayG5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_date_display_g5);  //activity_date_display_g5);

        Intent intent = getIntent();
        myDate = intent.getStringExtra("ProdDate");
        RequestQueue requestQueue = Volley.newRequestQueue(this);

        final String url = "http://10.151.7.169/php/sail/all5_date.php?Production_Date="+myDate;
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try{
                            ...
                            runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    CustomListAdapter myAdapter = new CustomListAdapter(DateDisplayG5.this, jsonKeys, jsonVals, imageIds);
                                    //myAdapter.printVal();
                                    ListView listView = findViewById(R.id.listViewDateG5);
