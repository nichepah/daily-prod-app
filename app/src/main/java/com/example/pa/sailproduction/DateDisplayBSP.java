...
public class DateDisplayBSP extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_date_display_bsp);

        Intent intent = getIntent();
        myDate = intent.getStringExtra("ProdDate");
        RequestQueue requestQueue = Volley.newRequestQueue(this);

        final String url = "http://10.151.7.169/php/sail/bsp_date.php?Production_Date="+myDate;
        final Integer imageId = R.mipmap.ic_bsp;
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try{
                            ...
                            runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    CustomListAdapter myAdapter = new CustomListAdapter(DateDisplayBSP.this, jsonKeys, jsonVals, imageIds);
                                    //myAdapter.printVal();
                                    ListView listView = findViewById(R.id.listViewDateBSP);
