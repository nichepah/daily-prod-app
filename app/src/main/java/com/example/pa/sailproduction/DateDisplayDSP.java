...
public class DateDisplayDSP extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_date_display_dsp);


        Intent intent = getIntent();
        myDate = intent.getStringExtra("ProdDate");

        final String url = "http://10.151.7.169/php/sail/dsp_date.php?Production_Date="+myDate;
        final Integer imageId = R.mipmap.ic_dsp;
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try{
                            ...
                            runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    CustomListAdapter myAdapter = new CustomListAdapter(DateDisplayDSP.this, jsonKeys, jsonVals, imageIds);
                                    //myAdapter.printVal();
                                    ListView listView = findViewById(R.id.listViewDateDSP);
